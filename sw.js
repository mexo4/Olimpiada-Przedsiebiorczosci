...
self.addEventListener('fetch',e=>{
  ...
  const freshData=/\/(?:op-raw\.json|op-data\.json|key-index\.json)$/.test(u.pathname)||/\/keys\/.*\.pdf$/i.test(u.pathname)||/\/vendor\/pdf.*\.mjs$/i.test(u.pathname);
  if(shell||freshData){
